...
public class Transazione {
    ...
    private String note; // NUOVA COLONNA

    // COSTRUTTORE 1: Usato per salvare NUOVI scontrini
    public Transazione(String codiceTessera, String codiceBarre, int quantita, int puntiSpesi, String note){
    ...
    public Transazione(String codiceTessera, String codiceBarre, int quantita, int puntiSpesi, String dataOperazione, String note){
        this.codiceTessera = codiceTessera;
        this.codiceBarre = codiceBarre;
        this.quantita = quantita;
        this.puntiSpesi = puntiSpesi;
